...
+ (NSString *) getDbFilePath
{
    ...
    NSLog(@"%@", [docsPath stringByAppendingPathComponent:@"catalog.db"]);
    return [docsPath stringByAppendingPathComponent:@"catalog.db"];
}

+ (void)initDB{
     [self createCategoriesLandingPageTable:[self getDbFilePath]];
   //if(![[NSFileManager defaultManager] fileExistsAtPath:[self getDbFilePath]]) //if the file does not exist
    //{
        ...
        [self createDetailTable:[self getDbFilePath]];
    //}
}
...
+ (int)createLandingPageTable:(NSString*)filePath
{
    ...
    {
        char * query ="CREATE TABLE IF NOT EXISTS LandingPage (ID INTEGER PRIMARY KEY AUTOINCREMENT, postID text, title text, content text,contentSummary text,contentHTML text, imageUrl text, publish_date text, categoryId text, categoryName text, userAvatarUrl text, userTitle text, userJobTitle text, userPageId text, userEntity text, userEntityId text, likes_count text, recommends_count text, favorites_count text, liked text, favorite text, recommended text, tags text, postType text, audioUrl text, videoUrl text, audioSize integer, videoSize integer, videoSnapshot text, votingOptions text, priority integer)";
        char * errMsg;
...
+ (int)createCategoriesLandingPageTable:(NSString*)filePath
{
    sqlite3* db = NULL;
    int rc=0;
    ...
    {
        char * query ="CREATE TABLE IF NOT EXISTS CategoriesLandingPage (ID INTEGER PRIMARY KEY AUTOINCREMENT, postID text, title text, content text,contentSummary text,contentHTML text, imageUrl text, publish_date text, categoryId text, categoryName text, userAvatarUrl text, userTitle text, userJobTitle text, userPageId text, userEntity text, userEntityId text, likes_count text, recommends_count text, favorites_count text, liked text, favorite text, recommended text, tags text, postType text, audioUrl text, videoUrl text, audioSize integer, videoSize integer, videoSnapshot text, votingOptions text, priority integer)";
        char * errMsg;
        rc = sqlite3_exec(db, query,NULL,NULL,&errMsg);
...
+ (int)createDetailTable:(NSString*)filePath
{
    sqlite3* db = NULL;
    int rc=0;
    ...
    {
        char * query ="CREATE TABLE IF NOT EXISTS Detail (ID INTEGER PRIMARY KEY AUTOINCREMENT, postID text, title text, coverImage text,postName text,logoImage text,logoFirstName text,logoLastName text,elements text)";
        char * errMsg;
        rc = sqlite3_exec(db, query,NULL,NULL,&errMsg);
...
+ (int)createCategoriesTable:(NSString*)filePath
{
    ...
    {
        char * query ="CREATE TABLE IF NOT EXISTS Categories (ID INTEGER PRIMARY KEY AUTOINCREMENT, catId text, catName text,catIcon text,catPriority text,catTags text)";
        char * errMsg;
        rc = sqlite3_exec(db, query,NULL,NULL,&errMsg);
...
+ (int)insertIntoLandingPageWithFilePath:(NSString *)filePath
    ...
    else
    {
        NSString * query  = [NSString
                             stringWithFormat:@"INSERT INTO LandingPage(postID, title, content, contentSummary, contentHTML, imageUrl, publish_date, categoryId, categoryName, userAvatarUrl, userTitle, userJobTitle, userPageId, userEntity, userEntityId, likes_count, recommends_count, favorites_count, liked, favorite, recommended, tags, postType, audioUrl, videoUrl, audioSize, videoSize, videoSnapshot, votingOptions, priority) VALUES (\"%@\",\"%@\",\"%@\",\"%@\", \"%@\",\"%@\",\"%@\",\"%@\",\"%@\",\"%@\" ,\"%@\",\"%@\",\"%@\",\"%@\", \"%@\",\"%@\" ,\"%@\",\"%@\" ,\"%@\",\"%@\",\"%@\" ,\'%@\',\"%@\",\"%@\",\"%@\",\'%ld\',\'%ld\',\"%@\",\"%@\", \"%ld\")", postID, title, content, contentSummary, contentHTML, imageUrl, publish_date, categoryId, categoryName, userAvatarUrl, userTitle, userJobTitle, userPageId, userEntity, userEntityId, likes_count, recommends_count, favorites_count, liked, favorite, recommended, tagsStr, postType, audioUrl, videoUrl, (long)audioSize, (long)videoSize, videoSnapshot, optionsStr, (long)priority];
...
+ (int)insertIntoCategoriesLandingPageWithFilePath:(NSString *)filePath
                                  postID:(NSString *)postID
                                   title:(NSString *)title
                                 content:(NSString *)content
                          contentSummary:(NSString *)contentSummary
    ...
    {
        NSString * query  = [NSString
                             stringWithFormat:@"INSERT INTO CategoriesLandingPage(postID, title, content, contentSummary, contentHTML, imageUrl, publish_date, categoryId, categoryName, userAvatarUrl, userTitle, userJobTitle, userPageId, userEntity, userEntityId, likes_count, recommends_count, favorites_count, liked, favorite, recommended, tags, postType, audioUrl, videoUrl, audioSize, videoSize, videoSnapshot, votingOptions, priority) VALUES (\"%@\",\"%@\",\"%@\",\"%@\", \"%@\",\"%@\",\"%@\",\"%@\",\"%@\",\"%@\" ,\"%@\",\"%@\",\"%@\",\"%@\", \"%@\",\"%@\" ,\"%@\",\"%@\" ,\"%@\",\"%@\",\"%@\" ,\'%@\',\"%@\",\"%@\",\"%@\",\'%ld\',\'%ld\',\"%@\",\"%@\", \"%ld\")", postID, title, content, contentSummary, contentHTML, imageUrl, publish_date, categoryId, categoryName, userAvatarUrl, userTitle, userJobTitle, userPageId, userEntity, userEntityId, likes_count, recommends_count, favorites_count, liked, favorite, recommended, tagsStr, postType, audioUrl, videoUrl, (long)audioSize, (long)videoSize, videoSnapshot, optionsStr, (long)priority];
...
+ (int)insertIntoCategoriesWithFilePath:(NSString *)filePath
                                ...
                                catIcon:(NSString *)catIcon
                                catPriority:(NSString *)catPriority
                                catTags:(NSArray *)catTags{
    
    NSMutableString *tagsStr = [[NSMutableString alloc]init];
    for (NSDictionary *dic in catTags) {
        [tagsStr appendString:[NSString stringWithFormat:@"%@,",[dic objectForKey:@"id"]]];
        [tagsStr appendString:[NSString stringWithFormat:@"%@,,,",[dic objectForKey:@"name"]]];
    }
    ...
    {
        NSString * query  = [NSString
                             stringWithFormat:@"INSERT INTO Categories(catId, catName,catIcon,catPriority,catTags) VALUES (\"%@\",\"%@\",\"%@\",\"%@\",\"%@\")", catID, catName,catIcon,catPriority,tagsStr];
...
+ (int)insertIntoDetailWithFilePath:(NSString *)filePath
                             postID:(NSString *)postID
                              title:(NSString *)title
                         coverImage:(NSString *)coverImage
                           postName:(NSString *)postName
                          logoImage:(NSString *)logoImage
                      logoFirstName:(NSString *)logoFirstName
                       logoLastName:(NSString *)logoLastName
                           elements:(NSArray *)elements{
    
    NSMutableString *elementsStr = [[NSMutableString alloc]init];
    for (NSDictionary *dic in elements) {
        [elementsStr appendString:[NSString stringWithFormat:@"%@,",[dic objectForKey:@"screenshot"]]];
        [elementsStr appendString:[NSString stringWithFormat:@"%@,,,",[dic objectForKey:@"media"]]];
    }
    ...
    {
        NSString * query  = [NSString
                             stringWithFormat:@"INSERT INTO Detail(postID,title,coverImage,postName,logoImage,logoFirstName,logoLastName,elements) VALUES (\"%@\",\"%@\",\"%@\",\"%@\",\"%@\",\"%@\",\"%@\",\"%@\")", postID, title,coverImage,postName,logoImage,logoFirstName,logoLastName,elementsStr];
...
+ (NSArray *)selectFromCategoriesLandingPageWithFilePath:(NSString *)filePath{
    ...
    {
        NSString  * query = @"SELECT * from CategoriesLandingPage order by publish_date desc";
    ...
    else
    {
        ...
        if(rc == SQLITE_OK)
        {
            while (sqlite3_step(stmt) == SQLITE_ROW) //get each row in loop
            {
                ...
                NSString *catIcon =[NSString stringWithUTF8String:(const char *)sqlite3_column_text(stmt, 3)];
                NSString *catPriority =[NSString stringWithUTF8String:(const char *)sqlite3_column_text(stmt, 4)];
                NSString *catTags =[NSString stringWithUTF8String:(const char *)sqlite3_column_text(stmt, 5)];
                
                NSDictionary *category =[NSDictionary dictionaryWithObjectsAndKeys:catId, @"id", catName, @"name", catIcon, @"icon",catPriority, @"priority",catTags, @"tags",nil];
...
+ (NSArray *)selectFromLandingPageWithCategoryID:(NSString *)catID filePath:(NSString *)filePath{
    ...
    {
        NSString  * query = [NSString stringWithFormat:@"SELECT * from LandingPage  where categoryID = \"%@\" order by publish_date desc", catID];
...
+ (NSArray *)selectFromLandingPageWithTagName:(NSString *)tagName filePath:(NSString *)filePath{
    ...
    {
        NSString  * query = [NSString stringWithFormat:@"SELECT * from LandingPage where title LIKE \"%%%@%%\" order by publish_date desc", tagName];
...
+ (NSDictionary *)selectFromDetailWithID:(NSString *)postID WithFilePath:(NSString *)filePath{
    ...
    {
        NSString  * query = [NSString stringWithFormat:@"SELECT * from Detail  where postID = \"%@\"", postID];
        ...
        if(rc == SQLITE_OK)
        {
            while (sqlite3_step(stmt) == SQLITE_ROW) //get each row in loop
            {
                ...
                NSString *postID =[NSString stringWithUTF8String:(const char *)sqlite3_column_text(stmt, 1)];
                NSString *title =[NSString stringWithUTF8String:(const char *)sqlite3_column_text(stmt, 2)];
                NSString *coverImage =[NSString stringWithUTF8String:(const char *)sqlite3_column_text(stmt, 3)];
                NSString *postName =[NSString stringWithUTF8String:(const char *)sqlite3_column_text(stmt, 4)];
                NSString *logoImage =[NSString stringWithUTF8String:(const char *)sqlite3_column_text(stmt, 5)];
                NSString *logoFirstName =[NSString stringWithUTF8String:(const char *)sqlite3_column_text(stmt, 6)];
                NSString *logoLastName =[NSString stringWithUTF8String:(const char *)sqlite3_column_text(stmt, 7)];
                NSString *elements =[NSString stringWithUTF8String:(const char *)sqlite3_column_text(stmt, 8)];
                
                post =[NSDictionary dictionaryWithObjectsAndKeys:postID, @"postID", title, @"title", coverImage, @"coverImage", postName, @"postName", logoImage, @"logoImage", logoFirstName, @"logoFirstName", logoLastName, @"logoLastName", elements, @"elements", nil];
            }
            //NSLog(@"Done");
            sqlite3_finalize(stmt);
        }
...
+(int)deleteDuplicateDataCategoriesLandingPageWithFilePath:(NSString *)filePath{
    /*
     delete   from landingpage
     where    rowid not in
     (
    ...
    {
        char * query ="delete from CategoriesLandingPage where rowid not in (select  min(rowid) from CategoriesLandingPage group by postid)";
        char * errMsg;
        rc = sqlite3_exec(db, query,NULL,NULL,&errMsg);
...
+(int)deleteCategoriesLandingPageWithFilePath:(NSString *)filePath{
    ...
    {
        char * query ="delete  from CategoriesLandingPage where 1=1";
        char * errMsg;
        rc = sqlite3_exec(db, query,NULL,NULL,&errMsg);
...
+(int)deleteCategoriesLandingPageWithFilePath:(NSString *)filePath withID:(NSString *)postID{
    ...
    {
        NSString *query =[NSString stringWithFormat:@"delete froM CategoriesLandingPage where postID = \"%@\"", postID];
        char * errMsg;
        rc = sqlite3_exec(db, [query UTF8String] ,NULL,NULL,&errMsg);
        if(SQLITE_OK != rc)
        {
...
+(int)deleteDuplicateDataDetailWithFilePath:(NSString *)filePath{
    /*
     delete   from landingpage
     where    rowid not in
     (
    ...
    {
        char * query ="delete from Detail where rowid not in (select  min(rowid) from Detail group by postid)";
        char * errMsg;
        rc = sqlite3_exec(db, query,NULL,NULL,&errMsg);
