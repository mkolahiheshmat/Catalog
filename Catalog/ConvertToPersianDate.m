...
+(double)ConvertToUNIXDateWithShamsiYear:(NSInteger)year month:(NSInteger)month day:(NSInteger)day
{
    ...
    [components setSecond:[[NSTimeZone systemTimeZone] secondsFromGMT]];
    
    return [[gregorian dateFromComponents:components]timeIntervalSince1970];
}
...
+(NSString*)ConvertToPersianFromGregorianDate:(NSDate *)GregorianDateTime
{
    NSCalendar *persianCalender = [[NSCalendar alloc] initWithCalendarIdentifier:NSCalendarIdentifierPersian];
    unsigned units = NSCalendarUnitYear | NSCalendarUnitMonth | NSCalendarUnitDay | NSCalendarUnitHour | NSCalendarUnitMinute | NSCalendarUnitSecond | NSCalendarUnitWeekday | NSCalendarUnitYearForWeekOfYear;
    NSDateComponents *componentsNow = [persianCalender components:units fromDate:GregorianDateTime];
...
+(NSString*)ConvertToPersianFromGregorianDate2:(NSDate *)GregorianDateTime
{
    ...
    NSString *month = [NSString stringWithFormat:@"%ld", (long)[componentsNow month]];
    NSString *day = [NSString stringWithFormat:@"%ld", (long)[componentsNow day]];
    NSString *weekday = [NSString stringWithFormat:@"%ld", (long)[componentsNow weekday]];
    ...
    [weekdayDic setObject:@"شنبه" forKey:@"0"];
    [weekdayDic setObject:@"یکشنبه" forKey:@"1"];
    [weekdayDic setObject:@"دوشنبه" forKey:@"2"];
    [weekdayDic setObject:@"سه شنبه" forKey:@"3"];
    [weekdayDic setObject:@"چهارشنبه"   forKey:@"4"];
    [weekdayDic setObject:@"پنج شنبه" forKey:@"5"];
    [weekdayDic setObject:@"جمعه" forKey:@"6"];
    [weekdayDic setObject:@"شنبه" forKey:@"7"];
    weekday = [weekdayDic objectForKey:weekday];
    
    NSString *PersianDate =[NSString stringWithFormat:@"%@ %@ %@ %@",weekday,day, month,year ];
...
+ (NSString *)convertToShamsi:(double)timeStamp{
    ...
    return [self ConvertToPersianFromGregorianDate2:startDate];
}
...
+ (NSString *)convertToShamsiWithoutWeekDay:(double)timeStamp{
    ...
    NSTimeInterval timestamp = (NSTimeInterval)timestampval;
    NSDate *startDate = [NSDate dateWithTimeIntervalSince1970:timestamp];
    return [self ConvertToPersianFromGregorianDate:startDate];
}
@end
